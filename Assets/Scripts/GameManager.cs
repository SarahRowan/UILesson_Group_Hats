...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        node8 = new Node("Sploosh, sploosh, sploosh. Everything is wet and terrible. But it could have been worse. You could have died or something", "Do it again", "Maybe tomorrow it won't rain?", node1, node1);
        node7 = new Node("Oops. You fall in and drown", "Ugh.", "Try to swim?", node4, node4);
        node6 = new Node("In your very rude hurry, you slip and fall into a deep hole, filled with nameless beasts who harvest souls", "Fight them", "Climb back out", node4, node4);
        node5 = new Node("She accept your gift and decides not to curse you", "Hurry away quickly", "Continue trudging in the rain", node6, node1);
        node4 = new Node("Great, you died. Now your day is even worse!", "Start over!", "Try again", node1, node1);
        node3 = new Node("You keep your head down, trying to avoid getting rain in your eyes. There's a huge puddle with a log-bridge in your way","Cross the bridge!", "Go round!", node7, node8);
        node2 = new Node("Oh no, a witch!", "Fight her!", "Give her your hair", node4, node5);
		node1 = new Node("You're walking through the woods", "LOOK FOR DANGER", "Chill out", node2, node3);
